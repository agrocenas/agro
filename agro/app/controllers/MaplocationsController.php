...
class MaplocationsController extends ControllerBase {

    public function initialize() {
        $this->view->setTemplateAfter('main');
        Phalcon\Tag::setTitle('Mapa');
        parent::initialize();
    }

    public function indexAction() {
        $this->session->conditions = null;
        $this->view->setVar("maplocations" , Maplocations::find() );
        
        //echo  $this->view->getParams();
    }

    public function ShowMaplocationsAction() {
        // Store map data in view variable json encoded
        $this->view->setVar("maplocations" , Maplocations::find() );
        //($this->view->setVar("maplocations" , json_encode( Maplocations::find() ));
    }
