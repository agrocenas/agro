...
INSERT INTO `comments` VALUES (1, 1, 1, 1, '2013-04-10 20:53:01', 5 , 'nice vegies', 'tasted it yesterday and they are great!', 'Y');
INSERT INTO `comments` VALUES (2, 2, 1, 2, '2013-04-11 20:53:02', 5 , 'good', 'tasted it yesterday and they are great!', 'Y');
INSERT INTO `comments` VALUES (3, 1, 2, 1, '2013-04-12 20:53:03', 5 , 'suck', 'tasted it yesterday and they are shit!', 'Y');
INSERT INTO `comments` VALUES (4, 2, 2, 3, '2013-04-13 20:53:04', 5 , 'fraud!', '=)#$#%$%"$##!', 'Y');
INSERT INTO `comments` VALUES (5, 2, 2, 4, '2013-04-14 20:53:05', 5 , 'cheater', 'payed and not receive a thing!', 'Y');
INSERT INTO `comments` VALUES (6, 2, 3, 2, '2013-04-15 20:53:06', 5 , 'nice vegies1', 'tasted it yesterday and they are great!', 'Y');
INSERT INTO `comments` VALUES (7, 2, 3, 3, '2013-04-16 20:53:07', 5 , 'nice vegies2', 'tasted it yesterday!', 'Y');
INSERT INTO `comments` VALUES (8, 2, 3, 2, '2013-04-17 20:53:08', 5 , 'nice vegies3', 'tasted it yesterday', 'Y');
INSERT INTO `comments` VALUES (9, 2, 3, 1, '2013-04-18 20:53:09', 5 , 'nice vegies4', 'tasted it !', 'Y');
INSERT INTO `comments` VALUES (10, 2, 4, 4, '2013-04-19 20:53:10', 5 , 'nice ', 'some dirt', 'Y');
INSERT INTO `comments` VALUES (11, 2, 5, 1, '2013-04-20 20:53:11', 5 , 'cool', 'had one rotten!', 'Y');
UNLOCK TABLES;
...
INSERT INTO `comment_type` VALUES (1 , 'Comentario', 'Comentario cenas'); 
INSERT INTO `comment_type` VALUES (2 , 'Interese', 'Interesse cenas'); 
INSERT INTO `comment_type` VALUES (3 , 'Aval', 'Aval cenas'); 
INSERT INTO `comment_type` VALUES (4 , 'Recomendacao', 'Ele e bom!'); 
UNLOCK TABLES;
...
INSERT INTO `ratings` VALUES (1 , 'Fraude', 'Nao é produtor, não entrega os produtos, outras'); 
INSERT INTO `ratings` VALUES (2 , 'Mau', 'Produtos estragados,outras');
INSERT INTO `ratings` VALUES (3 , 'A melhorar', 'Má apresentação,outras');
INSERT INTO `ratings` VALUES (4 , 'Satisfatorio', 'O Normal');
INSERT INTO `ratings` VALUES (5 , 'Bom', 'Supera as expectativas');
INSERT INTO `ratings` VALUES (6 , 'Excelente', 'Bom preço, boa qualidate, pontual, outras ');
UNLOCK TABLES;

-- map locations
LOCK TABLES `maplocations` WRITE;
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (1,'Amelia Maria','Golega',39.402512,-8.491393,'user');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (2,'ze manel','Travessa da Cruz, brancos, Torres vedras',39.107265,-9.148924,'supplier');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (3,'Maria','Av. Professor Egas Moniz, Lisboa, Portugal',38.750423,-9.162045,'user');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (4,'Isaura','Rua Antonio Macedo, Lisboa, Portugal',38.740562,-9.178077,'user');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (5,'Patricio','Rua Buraca, Lisboa, Portugal',38.741890,-9.203204,'supplier');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (6,'Antonieta','Campo Grande, Lisboa, Portugal',38.757915,-9.203204,'user');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (7,'Chico cesar','Estrada Militar, Sacavem, Portugal',38.812344,-9.115776,'supplier');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (8,'Carlos Alberto','Rua Pedro Alvares Cabral, Loures, Portugal',38.840717,-9.203204,'supplier');
INSERT INTO `maplocations` (`id`,`name`,`address`,`lat`,`lng`,`type`) VALUES (9,'Felismina maria','Rua Virginia Vitorino, Lisboa',38.840729,-9.160280,'user');UNLOCK  TABLES;
UNLOCK TABLES;
